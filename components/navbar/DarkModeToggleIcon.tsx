...
const DarkModeToggleIcon = () => {
  return (
    <div>
        <button type="button" id="headlessui-listbox-button-:r3:" aria-haspopup="true" aria-expanded="false" data-headlessui-state="" aria-labelledby="headlessui-listbox-label-:r2: headlessui-listbox-button-:r3:">
