...
const DarkModeToggleIcon:React.FC<DarkModeToggleIconProps> = ({
  ...
  return (
    <div>
        <button className='mr-2 ml-2 hover:shadow-md rounded-full p-2' type="button" onClick={onClick} id="headlessui-listbox-button-:r3:" aria-haspopup="true" aria-expanded="false" data-headlessui-state="" aria-labelledby="headlessui-listbox-label-:r2: headlessui-listbox-button-:r3:">
